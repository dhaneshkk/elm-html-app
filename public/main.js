...
Elm.Main.make = function (_elm) {
   ...
   var pageBody = A2($Html.div,
   _L.fromArray([]),
   _L.fromArray([A2($Html.p,
                _L.fromArray([]),
                _L.fromArray([$Html.text("* In this example we use a mobile first approach")]))
                ,A2($Html.p,
                _L.fromArray([]),
                _L.fromArray([$Html.text("* Resize the window to see how the cycle and uncycle variables work")]))]));
